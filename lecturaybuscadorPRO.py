...
def init_firebase():
    ...
    if not firebase_admin._apps:
        try:
            # Opción 1: Cuando el JSON está en una subclave como "service_account"
            # key_dict = json.loads(st.secrets["firebase"]["service_account"])
            
            # Opción 2: Cuando el JSON está directamente en la sección "firebase"
            # Esta opción es más probable que funcione con las últimas versiones de Streamlit.
